...
component {
	...
	// Module Entry Point
	this.entryPoint         = "api/v06";
	// Model Namespace
	this.modelNamespace     = "api-v06";
	// CF Mapping
	this.cfmapping          = "api-v06";
	// Auto-map models
	...
	function configure() {
		...
		variables.settings = {
			cbsecurity : {
				...
				"invalidAuthenticationEvent"  : "api-v06:main.index",
				// Default Auhtentication Action: override or redirect when a user has not logged in
				"defaultAuthenticationAction" : "redirect",
				// Module override event when an invalid access is detected, instead of each rule declaring one.
				"invalidAuthorizationEvent"   : "api-v06:main.index",
