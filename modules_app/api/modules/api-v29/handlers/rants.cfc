...
component extends="coldbox.system.RestHandler" {
	...
	// DI
	property name="rantService" inject="quickService:Rant@api-v29";
	property name="userService" inject="quickService:User@api-v29";
	...
	function create( event, rc, prc ) secured {
		...
		var rant = getInstance( "Rant@api-v29" ).fill( { body : rc.body, userID : rc.userID } );
		validateOrFail( rant );
