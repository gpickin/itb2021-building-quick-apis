...
component {
	...
	// Module Entry Point
	this.entryPoint = "api/v19";
	// Model Namespace
	this.modelNamespace = "api-v19";
	// CF Mapping
	this.cfmapping = "api-v19";
	// Auto-map models
	...
	function configure() {
		...
		variables.settings = {
			cbsecurity : {
				...
				"invalidAuthenticationEvent"  : "api-v19:main.index",
				// Default Auhtentication Action: override or redirect when a user has not logged in
				"defaultAuthenticationAction" : "redirect",
				// Module override event when an invalid access is detected, instead of each rule declaring one.
				"invalidAuthorizationEvent"   : "api-v19:main.index",
