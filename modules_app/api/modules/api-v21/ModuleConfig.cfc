...
component {
	...
	// Module Entry Point
	this.entryPoint         = "api/v21";
	// Model Namespace
	this.modelNamespace     = "api-v21";
	// CF Mapping
	this.cfmapping          = "api-v21";
	// Auto-map models
	...
	function configure() {
		...
		variables.settings = {
			cbsecurity : {
				...
				"invalidAuthenticationEvent"  : "api-v21:main.index",
				// Default Auhtentication Action: override or redirect when a user has not logged in
				"defaultAuthenticationAction" : "redirect",
				// Module override event when an invalid access is detected, instead of each rule declaring one.
				"invalidAuthorizationEvent"   : "api-v21:main.index",
