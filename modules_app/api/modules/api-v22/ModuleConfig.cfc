...
component {
	...
	// Module Entry Point
	this.entryPoint         = "api/v22";
	// Model Namespace
	this.modelNamespace     = "api-v22";
	// CF Mapping
	this.cfmapping          = "api-v22";
	// Auto-map models
	...
	function configure() {
		...
		variables.settings = {
			cbsecurity : {
				...
				"invalidAuthenticationEvent"  : "api-v22:main.index",
				// Default Auhtentication Action: override or redirect when a user has not logged in
				"defaultAuthenticationAction" : "redirect",
				// Module override event when an invalid access is detected, instead of each rule declaring one.
				"invalidAuthorizationEvent"   : "api-v22:main.index",
